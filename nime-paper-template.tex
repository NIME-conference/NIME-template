...
As noted in the introduction, the ``\verb|nimeart|'' document class can
...
The primary parameter given to the ``\verb|nimeart|'' document class is
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{images/sample-bela.jpg}
